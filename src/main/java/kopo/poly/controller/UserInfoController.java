...
public class UserInfoController {
    ...
    public UserInfoDTO getUserExists(HttpServletRequest request) throws Exception {
        ...
        log.info("{}.geUserExists Start!", this.getClass().getName());
        ...
        log.info("{}.geUserExists End", this.getClass().getName());
    ...
    public MsgDTO insertUserInfo(HttpServletRequest request) throws Exception {
        ...
        String msg; // 회원가입 결과에 대한 메시지를 전달한 변수
        ...
        UserInfoDTO pDTO = UserInfoDTO.builder()
                .userId(userId)
                .userName(userName)
                .password(EncryptUtil.encHashSHA256(password))      // 해시암호화 (복호화 불가능)
                .email(EncryptUtil.encAES128CBC(email))     // AES128-CBC 암호화   (복호화 가능)
                .addr1(addr1)
                .addr2(addr2)
                .regId(userId)
                .chgId(userId)
